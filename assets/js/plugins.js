...
--------------------------------------------- */
(function(c, k, l) {
    function f() { return parseInt(e.scrollTop() + e.height()) === parseInt(m.height()) ? !0 : !1 }

    function g(a) { return null === a ? 0 : "string" === typeof a && 0 < c(a).length ? c(a).outerHeight() : console.log("Section Scroller Error: Wrong fixedNavbar option provided!") }
    var e = c(k),
        m = c(l),
        h = { scrollerButton: "#section-scroller-button", scrollerButtonRotateClass: "rotate", scrollType: "swing", scrollDuration: 1E3, offset: 0, fixedNavbar: null, onScrollStart: function() {}, onScrollEnd: function() {} },
        d = function(a, b) {
            this.elements =
                a;
    ...
    d.prototype = {
        ...
        init: function() {
            ...
            e.scroll(function() { a.scrollerButtonRotateClassHandler(a) })
        },
        scrollToNextElement: function(a) {
            ...
            }, a.scrollDuration, a.scrollType).promise().done(function() { a.options.onScrollEnd.call(a) })
        },
    ...
    c.fn.sectionScroller = function(a) { c.data(this, "plugin_sectionScroller") || c.data(this, "plugin_sectionScroller", new d(this, a)); return this }
